...
-- Personal keybinds
bind("SUPER CTRL", "D", exec_cmd("discord"), { description = "Discord" })
bind("SUPER CTRL", "C", exec_cmd("code"), { description = "VS Code" })
bind("SUPER CTRL", "A", exec_cmd("gnome-calendar"), { description = "Calendar" })
bind("SUPER CTRL", "I", exec_cmd("flatpak run com.jetbrains.IntelliJ-IDEA-Ultimate"), { description = "IntelliJ" })
bind("SUPER CTRL", "M", exec_cmd("flatpak run com.spotify.Client"), { description = "Spotify" })
bind(
	"SUPER SHIFT",
	"T",
	exec_cmd(os.getenv("HOME") .. "/.config/hypr/scripts/Kitty_themes.sh"),
	{ description = "Change kitty theme" }
)
